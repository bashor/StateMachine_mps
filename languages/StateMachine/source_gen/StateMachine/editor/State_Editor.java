...
public class State_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_sjqidp_d0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createProperty_sjqidp_c3a(editorContext, node));
    ...
    editorCell.addEditorCell(this.createConstant_sjqidp_f3a(editorContext, node));
    editorCell.addEditorCell(this.createRefNodeList_sjqidp_g3a(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createConstant_sjqidp_e3a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "transactions");
    editorCell.setCellId("Constant_sjqidp_e3a");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private EditorCell createConstant_sjqidp_f3a(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, ":");
  ...
  private EditorCell createRefNodeList_sjqidp_g3a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new State_Editor.transactionsListHandler_sjqidp_g3a(node, "transactions", editorContext);
  ...
  private EditorCell createProperty_sjqidp_c3a(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new PropertyCellProvider(node, editorContext);
    provider.setRole("final");
    provider.setNoTargetText("<no final>");
    EditorCell editorCell;
    editorCell = provider.createEditorCell(editorContext);
    editorCell.setCellId("property_final");
    {
      Style style = editorCell.getStyle();
      style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    }
  ...
  private static class transactionsListHandler_sjqidp_g3a extends RefNodeListHandler {
    public transactionsListHandler_sjqidp_g3a(SNode ownerNode, String childRole, EditorContext context) {
